...
public class UserManager extends HttpServlet {
	...
	private static final long serialVersionUID = -5564561953273494052L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			case 5:
				...
				break;
			case 6:
				checkOpenedInProgressTasks(data, resp, req);
				break;
	...
	private void checkOpenedInProgressTasks(JSONObject data, HttpServletResponse resp, HttpServletRequest req) {
		try {
			String userName = data.getString("userName");

			Long notFinishedTasks = userTable.getUserTasksOpenedAndInProgress(userName);

			JSONObject result = new JSONObject();
			result.put("size", String.valueOf(notFinishedTasks));
